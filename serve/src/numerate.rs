/// Модуль позволяет преобразовывать числа в строки прописью
/// (например, 103 - "сто три").
...
/// Функция строит строковое представление числа и возвращает его клиенту. Поддерживаются
/// только неотрицальные числа менее одной тысячи.
